...
<template>
  ...
  <div class="section section--featured">
    ...
    <div class="hero">
      <h1>My Portfolio</h1>
      <h2>Have a look at some of my recent work!</h2>
    ...
    <div class="row">
      <div class="column">
        <div class="ItemCard">
          <a class="ItemCard__dest cover" href="https://dylans.site/_2023/data/img/hhl-website.png" target="_blank"></a>
...
<!--          <figure class="ItemCard__thumb">-->
<!--            <img src="https://dylans.site/_2023/data/img/hhl-website.png" height="340" width="510" alt="">-->
<!--&lt;!&ndash;            <span class="shadow cover"></span>&ndash;&gt;-->
<!--          </figure>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="column">-->
